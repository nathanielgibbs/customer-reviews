...
var reviewers = ["WillHa85", "GoldFry26", "Mittens41", "Tompkins8"];
var reviewType = ["P", "N", "", ""]
var stars = [5, 2, 1, 4];
var reviewDates = ["11/18/2024", "11/17/2024", "11/15/2024", "11/10/2024"];
var reviews = [
...
var reviewTitles = ["My Favorite Workout Game", "Poor Choreography", "Buggy with Poor Tech Support", "Nice Improvement"];
...
for (let i = 0; i < reviewers.length; i++) {
    ...
    reviewCode += "<tr><th>Review Dates</th><td>" + reviewDates[i] + "</td></tr>";
